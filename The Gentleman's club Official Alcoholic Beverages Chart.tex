...
\paragraph{Kommentar:} En studie av bygdafest anno 2014. Lørdag 05.10.2014 var vi bett på bygdafest på Kvalvaag. Annledningen var ett 50 årslag. Frekvensen av dressjakke, t-skjorte, jeans og sylspisse pub til pub sko var akkurat som forventet på bygdafest. Hårsveiser fra 70-tallet og flatfyll var også som forventet. Men det som overasket mektig var maten (som var noe av det beste jeg har smakt) og øllet som også hadde meget høy kvalitet. Kvalvaag IPA er en standard, men veldig god IPA. Hadde du fått den servert på pub så hadde du tenkte at det var en god om dog ikke ekstraordiner IPA. Litt på den lyse siden av IPA.
-- -- Isak 05.10.2014
