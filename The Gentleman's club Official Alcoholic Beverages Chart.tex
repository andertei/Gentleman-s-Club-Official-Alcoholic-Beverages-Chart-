...
\subsubsection{Kinn: Slåtteøl}
\paragraph{Kommentar:}Helt grei, ganske fruktig og sommerlig. Ikke helt min type øl, men den er god. Som vanlig skuffer ikke Kinn. 
\newline
-- -- Anders 3.2.2015

\begin{figure} [H]
\centering
\includegraphics[scale=0.08, angle=270]{Bilder/Ol/slotteolKinn.jpg} 
\caption{Slåtteøl fra "Kinn"}
\end{figure}
...
\newpage
\subsubsection{Founders Brewing: Dirty Bastard}
\paragraph{Kommentar:} En scotch ale type. Mye malt-preg og litt røyk. Smaker som en øl med en twist av whisky. En helt grei øl, men helt klart ikke min favoritt fra Founders Brewing. Kanskje noe for ale elskerne blant oss. 
\newline 
-- -- Isak 07.03.2015

\begin{figure} [H]
\centering 
\includegraphics[scale=0.1]{Bilder/Ol/dirtybastard}
\caption{Dirty Bastard fra "Founders Brewing"}
\end{figure} 
...
\subsubsection{Kinn: Skoddehav}
\paragraph{Kommentar:} "Kvit Indiaøl", dette var en ganske midl IPA, med veldig fruktig innslag. Den var veldig god, anbefaler alle denne. 
\newline
-- -- Anders 25.1.2015

\begin{figure} [H]
\centering
\includegraphics[scale=0.1, angle=270]{Bilder/Ol/kinnSkoddehav.jpg}
\caption{Skoddehav fra "Kinn"}
\end{figure}
\newpage
...
\paragraph{Kommentar:} Absoulutt en god IPA. Mye smak, tørr og fruktig. 
\newline
-- -- Isak 13.03.2015
...
\newpage
\subsubsection{Founders Brewing: Centennial IPA}
\paragraph{Kommentar:} En meget god og smakfull IPA. Intens lukt av humle. Bitter på en god måte og en behagelig tørr ettersmak. Kunne godt vært mer karbonert for min del. Kommer i flasker på 355ml og koster ca 50kr. Skulle gjerne ønske at flaskene var større, men høy alkoholprosent gjør at du får mye for pengene hvis du holde en rolig takt på drikkingen. Dette er en øl som alle som liker IPA bør prøve.
\newline
-- -- Isak 07.03.2015

\begin{figure} [H]
\centering
\includegraphics[scale=0.1]{Bilder/Ol/centennialipa}
\caption{Centennnial IPA fra "Founders Brewing"}
\end{figure}
 

\newpage
\subsubsection{Brewfist: Spaceman}
\paragraph{Kommentar:} Helt standard IPA, men god. Ikke spesielt bitter, men godt plassert inne i IPA området. 
\newline
-- -- Anders 15.05.2016

\begin{figure} [H]
\centering
\includegraphics[scale=0.1, angle= 270]{Bilder/Ol/spaceman_brewfist}
\caption{Spaceman fra "Brewfist"}
\end{figure}  
...
\newpage
\subsubsection{Boulevard Brewing: Pale Ale}
\paragraph{Kommentar:} Ikke noe jeg vil anbefale. Lite smak, kjedelig og bitter. Nå skal det sies at jeg egentlig ikke er spessielt glad i pale ale. Tror uansett at man kan gjøre bedre enn dette. 
\newline
-- -- Isak 14.03.2015

\begin{figure} [H]
\centering
\includegraphics[scale=0.1]{Bilder/Ol/boulevardpaleale}
\caption{Pale Ale fra "Boulevard Brewing"}
\end{figure}  

\newpage
\subsubsection{Lade Gaards bryggerihus: American Pale Ale}
\paragraph{Kommentar:} Ikke noe spesielt, men helt grei pale ale du får kjøpt til en "billig" penge på butikken. 
\newline
-- -- Anders 4.03.2015

\begin{figure} [H]
\centering
\includegraphics[scale=0.1, angle=270]{Bilder/Ol/LadeGaardPaleAle}
\caption{American Pale Ale fra "Lade Gaards bryggerihus"}
\end{figure}  
...
\newpage
\subsubsection{Founders Brewing: Porter Dark, Rich and Sexy}
\paragraph{Kommentar:} Ennå en innertier for Founders Brewing. En mørk og god porter som ikke smaker tjære. Smak av mørk sjokolada, søtlig og litt brent/røyk. Den nest beste porteren jeg har smakt så langt. 
\newline
-- -- Isak 07.03.2015

\begin{figure} [H]
\centering 
\includegraphics[scale=0.1]{Bilder/Ol/foundersporter}
\caption{Porter Dark, Rich and Sexy fra "Founders Brewing"}
\end{figure}
...
\subsubsection{Nøgne Ø: Kriek of Telemark}
\paragraph{Kommentar:}Æsj, smakte som saft. 
\newline
-- -- Anders 21.2.2015

\begin{figure} [H]
\centering
\includegraphics[scale=0.08, angle=270]{Bilder/Ol/KrisebarOl.jpg} 
\caption{Kriek of Telemark fra "Nøgne Ø"}
\end{figure}
